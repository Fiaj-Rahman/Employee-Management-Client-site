...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y bg-gray-500 text-gray-900 ">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold"><img src="/logo.png" alt="" className='w-20' /></span>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center text-gray-400">© 2024 ProQuestor. All rights reserved.</div>
</footer>
        </div>
    );
};
